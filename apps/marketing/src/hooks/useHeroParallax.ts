...
export type ParallaxLayer = {
  ...
  /** Maksimum kayma (px) */
  max: number;
  /** Hız çarpanı — düşük = daha yavaş (video için ~0.35) */
  factor: number;
};
...
/** Fare ile zarif derinlik parallax — yalnızca masaüstü */
export function useHeroParallax(
  ...
  useEffect(() => {
    ...
    // layers refs stable — intentional empty deps for mount-only setup
