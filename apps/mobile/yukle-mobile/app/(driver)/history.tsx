      ...
      <FlatList
        ...
        ListHeaderComponent={
          <>
            ...
            <View style={styles.summaryCard}>
              <Text style={styles.mutedSmall}>Toplam kazanc · Sefer</Text>
        ...
        renderItem={({ item }) => (
          <View style={styles.card}>
            ...
            <Text style={styles.muted}>Musteri: {item.customerName ?? '-'}</Text>
...
const styles = StyleSheet.create({
  ...
  summaryValue: { color: Colors.primaryGold, fontSize: 18, fontWeight: '700' },
  card: {
    backgroundColor: Colors.bgCard,
    borderRadius: 10,
    borderWidth: 1,
