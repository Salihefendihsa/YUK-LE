...
export function PageSkeleton({ rows = 4, variant = 'list' }: { rows?: number; variant?: SkeletonVariant }) {
  ...
  return (
    <div className="card skeleton-wrap" aria-busy>
...
export function PageError({ message, onRetry }: { message: string; onRetry?: () => void }) {
  return (
    <div className="error-banner" role="alert" style={{ display: 'flex', justifyContent: 'space-between', gap: 10, alignItems: 'center', flexWrap: 'wrap' }}>
