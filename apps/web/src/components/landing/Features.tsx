...
function FeatureCard({ feature }: { feature: Feature }) {
  return (
    <article data-feature-card className="marketing-surface-card lm-feature-card">
...
export function Features() {
  ...
  return (
    <section
      ref={sectionRef}
      id="ozellikler"
      className="section-rhythm-a section-rhythm--fade lm-section-pad lm-features-section"
