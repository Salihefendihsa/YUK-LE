...
namespace Yukle.Api.Migrations
{
    ...
    [Migration("20260609091154_AddListingOffers")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Yukle.Api.Models.DriverListing", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Status", "AvailableFrom");

                    b.ToTable("DriverListings");
                });
            ...
            modelBuilder.Entity("Yukle.Api.Models.ListingOffer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("DriverListingId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("DriverListingId", "Status");
            ...
            modelBuilder.Entity("Yukle.Api.Models.ListingOffer", b =>
                {
                    b.HasOne("Yukle.Api.Models.User", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Yukle.Api.Models.DriverListing", "DriverListing")
                        .WithMany()
                        .HasForeignKey("DriverListingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
